...
jQuery.validator.addMethod("IDCardValidate", function(value, element, param) {
	// var length = value.length;
	var validateMsg = checkCard(value);
	return this.optional(element) || (validateMsg.length == 0);
}, "身份证认证失败！");
