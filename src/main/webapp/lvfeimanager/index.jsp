	...
	<nav class="navbar navbar-default navbar-fixed-top">
		<div class="container">
			...
			<div class="floatRight navbar-brand font14">
				<span class="text-primary">欢迎登陆,${sessionScope.manager.username}</span>

				<a href="lvfeimanager/login_out"> <span
						...
						<div id="collapse1" class="panel-collapse collapse in">
							<div class="panel-body">
								...
								<div class="list-group">
									<a class="list-group-item list-group-item-info marginBottom3" id="firstAc"
										href="/lvfeimanager/getDataList">数据查看</a>
								</div>
								<div class="list-group">
									<a class="list-group-item list-group-item-info marginBottom3"
										href="/lvfeimanager/psdupdate.jsp">密码修改</a>
								</div>
								<!-- end -->
							</div>
						</div>
